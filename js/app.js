...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      previewTitle: '实时预览',
      copyBtn: '复制公式粘贴到 Word(仅 Microsoft Word)',
      exportBtn: '导出 Word 文档(Microsoft Word/WPS)',
    ...
    en: {
      ...
      copyBtn: 'Copy formula to Word (Microsoft Word only)',
      exportBtn: 'Export Word doc (Microsoft Word/WPS)',
